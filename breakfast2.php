...
<body>
    <div class="header">
        <h1 style='color:white'>CatersHub</h1>
    </div>
    
    <div class="nav">
        <a href="dashboardlogoff.php">Dashboard</a>
        <a href="lunch-dinner2.php"  >Lunch/Dinner</a>
        <a href="breakfast2.php" class="active">Breakfast</a>
