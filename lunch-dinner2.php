...
<body>
    ...
    <div class="nav">
        <a href="dashboardlogoff.php">Dashboard</a>
        <a href="lunch-dinner2.php"  class="active">Lunch/Dinner</a>
        ...
        <div class="filters">
                ...
                <div class="filter-options">
                    <?php if ($categories->num_rows > 0): ?>
                        <?php while($cat = $categories->fetch_assoc()): ?>
                            <a href="lunch-dinner2.php?category=<?php echo $cat['name']; ?>" 
            ...
            <?php if (!empty($category) && isset($cuisines) && $cuisines->num_rows > 0): ?>
                <div class="filter-section">
                    <h3>Cuisine</h3>
                    <div class="filter-options">
                        <a href="lunch-dinner2.php?category=<?php echo $category; ?>" 
                           class="filter-option <?php echo empty($cuisine) ? 'active' : ''; ?>">
                            All
                        </a>
                        <?php while($cuis = $cuisines->fetch_assoc()): ?>
                            <a href="lunch-dinner2.php?category=<?php echo $category; ?>&cuisine=<?php echo $cuis['name']; ?>" 
            ...
            <div class="filter-section">
                <h3>Price Range</h3>
                <div class="filter-options">
                    <a href="lunch-dinner2.php?category=<?php echo $category; ?>&cuisine=<?php echo $cuisine; ?>" 
                       class="filter-option <?php echo $price_range === 0 ? 'active' : ''; ?>">
                        All
                    </a>
                    <?php if ($price_ranges->num_rows > 0): ?>
                        <?php while($range = $price_ranges->fetch_assoc()): ?>
                            <a href="lunch-dinner2.php?category=<?php echo $category; ?>&cuisine=<?php echo $cuisine; ?>&price_range=<?php echo $range['id']; ?>" 
                ...
                <?php while($item = $menu_items->fetch_assoc()): ?>
                    <div class="menu-item">
                        ...
                        <div class="menu-item-info">
                            ...
                            <a href="user-login.php?id=<?php echo $item['id']; ?>" class="button">login to order</a>
                        </div>
                    </div>
                <?php endwhile; ?>
            <?php else: ?>
