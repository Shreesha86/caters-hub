...
// Get snacks menu items based on filters
// Get snacks menu items based on filters
...
<head>
    ...
    <title>Snacks Selection - Online Catering</title>
    <style>
        body {
...
<body>
    ...
    <div class="nav">
        ...
        <a href="snacks2.php" class="active">Snacks</a>
        <div class="dropdown">
    ...
    <div class="container">
                ...
                <div class="filter-options">
                    ...
                    <?php if ($price_ranges->num_rows > 0): ?>
                        <?php while($range = $price_ranges->fetch_assoc()): ?>
                            <a href="snacks2.php?price_range=<?php echo $range['id']; ?>" 
        ...
        <div class="menu-items">
            ...
            <?php else: ?>
                <div class="no-items">
                    <p>No snack items found matching your criteria. Please try different filters.</p>
                </div>
            <?php endif; ?>
        </div>
    </div>
